...
UNITREE_MODEL_DIR = "/root/gpufree-data/unitree_ws/unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "/root/gpufree-data/unitree_ws/unitree_ros"  # Replace with the actual path to your unitree_ros package
...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    ...
    actuators={
        "N7520-14.3": ImplicitActuatorCfg(
            ...
            armature=0.01017752,  # N7520-14.3
        ),
        "N7520-22.5": ImplicitActuatorCfg(
            ...
            armature=0.025101925,  # N7520-22.5
        ),
        "N5020-16": ImplicitActuatorCfg(
            joint_names_expr=[
                ".*_shoulder_.*",
